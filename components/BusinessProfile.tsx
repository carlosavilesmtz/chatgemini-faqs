...
const LogoIcon = () => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7L12 12L22 7L12 2Z" className="fill-sky-500" />
    <path d="M2 17L12 22L22 17L12 12L2 17Z" className="fill-sky-700" />
...
const ServiceIcon1 = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-sky-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="bg-slate-800/50 rounded-xl p-8 mb-16 flex flex-col md:flex-row justify-between items-center gap-8 border border-slate-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-sky-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-sky-700 transition-colors duration-200">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-slate-800 p-8 rounded-xl border border-slate-700 text-center hover:border-sky-500 hover:scale-105 transition-all duration-300">
                {service.icon}
              ...
              <div key={index} className="bg-slate-800 rounded-xl overflow-hidden border border-slate-700 flex flex-col group">
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <p className="text-slate-400 flex-grow">{product.description}</p>
                   <a href="#" className="mt-4 self-start text-sky-400 font-semibold hover:text-sky-300 transition-colors">
                    Ver más &rarr;
                  </a>
                </div>
              </div>
