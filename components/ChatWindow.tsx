  ...
  <div className="flex items-start gap-4 my-4">
    ...
    <div className="max-w-xl rounded-xl px-4 py-3 bg-slate-700 text-slate-200 rounded-bl-none shadow-md">
      <div className="flex items-center space-x-2">
        <div className="h-2 w-2 bg-amber-400 rounded-full animate-pulse [animation-delay:-0.3s]"></div>
        <div className="h-2 w-2 bg-amber-400 rounded-full animate-pulse [animation-delay:-0.15s]"></div>
